...
/*! \brief Method signature for handling finsihed HTTP downloads from the DMS.
	...
	a sucessful download would return the 200 http reponse.
...
/*!	\brief Allows the application to get the total number of bytes needed to be downloaded.
	...
	\returns The number of total bytes downloaded, which is the file size. If size is unknown
	it will be -1.
*/
...
/*!	\brief Pause download session using TCP flow control.  which it will keep the connection
...
/*!	\brief Shutdown the DMD from UPnP Chain
