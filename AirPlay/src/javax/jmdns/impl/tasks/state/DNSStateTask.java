        ...
        try {
            ...
            synchronized (this.getDns()) {
                if (this.getDns().isAssociatedWithTask(this, this.getTaskState())) {
                    Log.d("jmdns", this.getName() + ".run() JmDNS " + this.getTaskDescription() + " " + this.getDns().getName());
            ...
            for (ServiceInfo serviceInfo : this.getDns().getServices().values()) {
                ...
                synchronized (info) {
                    if (info.isAssociatedWithTask(this, this.getTaskState())) {
                        Log.d("jmdns", this.getName() + ".run() JmDNS " + this.getTaskDescription() + " " + info.getQualifiedName());
            ...
            if (!out.isEmpty()) {
                Log.d("jmdns", this.getName() + ".run() JmDNS " + this.getTaskDescription() + " #" + this.getTaskState());
