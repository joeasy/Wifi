...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_DEL              = 67;  // KEYCODE_KK_CHANNEL_RETURN
    ...
    public static final int KEYCODE_3D_MODE         = 206; // KEYCODE_3D_MODE
    ...
    /** @hide */
    public static final int KEYCODE_SLEEP           = 251;
    /** @hide */
    public static final int KEYCODE_PROGINFO        = 252;
    /** @hide */
    public static final int KEYCODE_FAVCH           = 253;
    /** @hide */
    public static final int KEYCODE_EPG             = 254; // KEYCODE_EPG
    /** @hide */
    public static final int KEYCODE_AUDIO           = 255;
    /** @hide */
    public static final int KEYCODE_VIDEO           = 256;
    /** @hide */
    public static final int KEYCODE_DISPLAY         = 257;
    /** @hide */
    public static final int KEYCODE_TOOL            = 258;
    /** @hide */
    public static final int KEYCODE_PIP             = 259;
    /** @hide */
    public static final int KEYCODE_POP             = 260;
    /** @hide */
    public static final int KEYCODE_MP              = 261;
    /** @hide */
    public static final int KEYCODE_JUMP            = 262;
    /** @hide */
    public static final int KEYCODE_WIDE            = 263;
    /** @hide */
    public static final int KEYCODE_CAPTION         = 264;
    /** @hide */
    public static final int KEYCODE_ROI             = 265;
    /** @hide */
    public static final int KEYCODE_FREEZE          = 266;  // KEYCODE_FREEZE
    /** @hide */
    public static final int KEYCODE_CARD            = 267;

    /** @hide */
    public static final int KEYCODE_QUICK_MENU      = 268;

//wangzhh add 20130530

    /** @hide */
    public static final int KEYCODE_KK_PROGRAM_LIST          = 1002; //KEYCODE_LIST
    /** @hide */
    public static final int KEYCODE_KK_CHANNEL_RETURN            = 1001; //no use now wangzhh
    /** @hide */
    public static final int KEYCODE_KK_PROGRAM_FAVORITE             = 1003; // no use now wangzhh
    /** @hide */
     public static final int KEYCODE_KK_EPG            = 1004;  // KEYCODE_YUV2
    /** @hide */
    public static final int KEYCODE_KK_3D         = 1005;  // KEYCODE_HDMI1
    /** @hide */
     public static final int KEYCODE_KK_AV            = 1010;  // KEYCODE_YUV2
    /** @hide */
    public static final int KEYCODE_KK_YPBPR         = 1011;  // KEYCODE_HDMI1
    /** @hide */
    public static final int KEYCODE_KK_HDMI             = 1012;  //  KEYCODE_AV1
    /** @hide */
    public static final int KEYCODE_KK_PICTURE_MODE          = 1013;  // KEYCODE_PICTURE_MODE
    /** @hide */
    public static final int KEYCODE_KK_DISPLAY_MODE          = 1014;  // KEYCODE_DISPLAY_MODE
    /** @hide */
    public static final int KEYCODE_KK_SOUND_MODE          = 1015;  //  KEYCODE_SOUND_MODE
     /** @hide */
    ...
    private static final int LAST_KEYCODE           = KEYCODE_KK_RC_HEADPHONE_PULL_OUT;
    ...
    private static void populateKeycodeSymbolicNames() {
        ...
        names.append(KEYCODE_PROGINFO, "KEYCODE_PROGINFO");
        names.append(KEYCODE_FAVCH, "KEYCODE_FAVCH");
        names.append(KEYCODE_EPG, "KEYCODE_EPG");
        names.append(KEYCODE_AUDIO, "KEYCODE_AUDIO");
        names.append(KEYCODE_VIDEO, "KEYCODE_VIDEO");
        names.append(KEYCODE_DISPLAY, "KEYCODE_DISPLAY");
        names.append(KEYCODE_TOOL, "KEYCODE_TOOL");
        names.append(KEYCODE_PIP, "KEYCODE_PIP");
        names.append(KEYCODE_POP, "KEYCODE_POP");
        names.append(KEYCODE_MP, "KEYCODE_MP");
        names.append(KEYCODE_JUMP, "KEYCODE_JUMP");
        names.append(KEYCODE_WIDE, "KEYCODE_WIDE");
        names.append(KEYCODE_CAPTION, "KEYCODE_CAPTION");
        names.append(KEYCODE_ROI, "KEYCODE_ROI");
        names.append(KEYCODE_FREEZE, "KEYCODE_FREEZE");
        names.append(KEYCODE_CARD, "KEYCODE_CARD");
       // wangzhh add
         names.append(KEYCODE_KK_PROGRAM_LIST, "KEYCODE_KK_PROGRAM_LIST");
        names.append(KEYCODE_KK_CHANNEL_RETURN, "KEYCODE_KK_CHANNEL_RETURN");
        names.append(KEYCODE_KK_PROGRAM_FAVORITE, "KEYCODE_KK_PROGRAM_FAVORITE");
  	 names.append(KEYCODE_KK_EPG, "KEYCODE_KK_EPG");
        names.append(KEYCODE_KK_3D, "KEYCODE_KK_3D");
        names.append(KEYCODE_KK_AV, "KEYCODE_KK_AV");
        names.append(KEYCODE_KK_YPBPR, "KEYCODE_KK_YPBPR");
        names.append(KEYCODE_KK_HDMI, "KEYCODE_KK_HDMI");
        names.append(KEYCODE_KK_PICTURE_MODE, "KEYCODE_KK_PICTURE_MODE");
        names.append(KEYCODE_KK_DISPLAY_MODE, "KEYCODE_KK_DISPLAY_MODE");
        names.append(KEYCODE_KK_SOUND_MODE, "KEYCODE_KK_SOUND_MODE");
        names.append(KEYCODE_KK_TV, "KEYCODE_KK_TV");
        names.append(KEYCODE_KK_VIDEO_FREEZE, "KEYCODE_KK_VIDEO_FREEZE");
        names.append(KEYCODE_KK_USB, "KEYCODE_KK_USB");
        names.append(KEYCODE_KK_FACTORY, "KEYCODE_KK_FACTORY");
        names.append(KEYCODE_KK_BURN_TV, "KEYCODE_KK_BURN_TV");
        names.append(KEYCODE_KK_VOICE_SEARCH, "KEYCODE_KK_VOICE_SEARCH");
        names.append(KEYCODE_KK_START_HANDWRITING, "KEYCODE_KK_START_HANDWRITING");
        names.append(KEYCODE_KK_FINISH_HANDWRITING, "KEYCODE_KK_FINISH_HANDWRITING");
        names.append(KEYCODE_KK_24G_TO_INFRARED, "KEYCODE_KK_24G_TO_INFRARED");
     	 names.append(KEYCODE_KK_INFRARED_TO_24G, "KEYCODE_KK_INFRARED_TO_24G");
        names.append(KEYCODE_KK_RC_HEADPHONE_INSERT, "KEYCODE_KK_RC_HEADPHONE_INSERT");
        names.append(KEYCODE_KK_RC_HEADPHONE_PULL_OUT, "KEYCODE_KK_RC_HEADPHONE_PULL_OUT");
